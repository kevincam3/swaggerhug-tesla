...
class DefaultApi
{
    ...
    public function __construct(\Swagger\Client\ApiClient $apiClient = null)
    {
        if ($apiClient === null) {
            ...
            $apiClient->getConfig()->setHost('https://virtserver.swaggerhub.com/kevincam3/Tesla-ModelS-API/0.0.1');
        }
    ...
    {
        list($response) = $this->vehicleGetWithHttpInfo();
        return $response;
    }
     ...
     */
    public function vehicleGetWithHttpInfo()
    {
        // parse inputs
